                        ...
                        <div class="product-default">
                            <figure>
                                <a href="{{URL::to('/san-pham/'.$product_category-> product_slug)}}">
                                    <img src="{{URL::to('public/upload/'.$product_category -> product_image)}}" style="width: 280px; height: 280px;"alt="product">
                                    <img src="{{URL::to('public/upload/'.$product_category -> product_image)}}" style="transform: scaleX(-1);width: 280px; height: 280px;" alt="product" />
                                </a>
                            ...
                            <div class="product-details">
                                ...
                                @if ($product_category->promotion_id != 0)
                                    ...
                                    @endphp
                                    <div class="price-box">
                                        <del class="old-price">{{ number_format($product_category->product_price) }}</del><br>
                                ...
                                @endif
                                <!-- End .price-box -->
                                <p style="color:#999;font-size: 1.4rem;">Đã bán: {{$product_category-> quantity_sold}}</p>

                                <div class="product-action">
                                  
                                            <form action="{{URL::to('/add-cart')}}" method="post">
                                                @csrf
                                                <input type="hidden" name="cart_product_id" value="{{$product_category-> product_id}}"
                                                class="cart_product_id_{{$product_category-> product_id}}">
                                                <input type="hidden" name="cart_product_name" value="{{$product_category-> product_name}}"
                                                class="cart_product_name_{{$product_category-> product_id}}">
                                                <input type="hidden" name="cart_product_image" value="{{$product_category-> product_image}}"
