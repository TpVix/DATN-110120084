					...
					<table class="table table-cart">
						...
						<tbody>
							...
							<tr class="product-row">
								...
								<td>
									<form action="{{URL::to('/update-cart/'.$cart-> product_id)}}" method="post" style="margin-bottom:0px;">
										@csrf
									<div class="product-single-qty">
										
		
									<input class="horizontal-quantity form-control" name="cart_qty_{{$cart-> product_id}}" value="{{$cart-> product_quantity}}" type="text">
									
									<div class="float-center">
										<button type="submit" class="btn btn-shop btn-update-cart" style="width: 100%;height: 4.6rem;">
											Cập nhật
										</button>
									</div>
								...
								<td class="text-right"><span class="subtotal-price">{{number_format($subtotal,0,',','.')}}đ</span></td>
							</tr>
							@endforeach
						</tbody>
